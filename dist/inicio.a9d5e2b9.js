...
function shop() {
    ...
    for(let index = 0; index < products.length; index++)shopBakery.appendChild(paint(products[index]));
}
...
//# sourceMappingURL=inicio.a9d5e2b9.js.map
