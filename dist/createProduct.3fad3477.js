...
})({"bygsu":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "4ca206383fad3477";
...
},{}],"5JtN2":[function(require,module,exports) {
var _app = require("../src/functions/app");
var _addProducts = require("../src/functions/addProducts");
...
const $form__item__img = document.querySelector("#form__item__img"), $imagenPrevisualizacion = document.querySelector("#imagenPrevisualizacion");
form.addEventListener("submit", async (ev)=>{
    ...
    if (itemName.value === '' || itemDescription.value === '' || itemPrice.value === '') alert("Hay campos sin llenar. Por favor llena los campos");
        ...
        if (img.length) {
            ...
            const uploadedImages = await _addProducts.uploadImages(_app.storage, [
                ...img
            ]);
        ...
        await _addProducts.addProduct(_app.db, newProducts);
...
},{"../src/functions/app":"04vpA","../src/functions/addProducts":"duJFs"}],"duJFs":[function(require,module,exports) {
...
async function imageUploadReference(storage, image) {
    const storageRef = _storage.ref(storage, `prducts/images/${image.name}`);
    return await _storage.uploadBytes(storageRef, image);
}
async function uploadImages(storage, img = []) {
    const uploadedImages = img.map(async (image)=>{
        //console.log(image)
...
},{"firebase/firestore":"cJafS","firebase/storage":"9dDUH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["bygsu","5JtN2"], "5JtN2", "parcelRequire46c0")

//# sourceMappingURL=createProduct.3fad3477.js.map
